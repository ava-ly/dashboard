...
export default function EmployeesStats() {
  ...
  const presentPercentage = (employeesPresent / totalEmployees) * 100;
    ...
    <>
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex gap-2">
              {presentPercentage > 75 ? <UserCheck2Icon /> : <UserRoundXIcon />}
          ...
          <CardFooter>
            {presentPercentage > 75 ? (
              ...
              <span className="text-xs text-red-500 flex gap-1 items-center">
                <AlertTriangleIcon />
                Only {presentPercentage}% of employees are present
              </span>
            )}
          </CardFooter>
        </Card>
